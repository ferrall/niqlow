...
@param L <em>string</em> a label or name for the variable.<br><em>default</em>&eq;&quot;a&quot;
@param N <em>positive integer</em> the number of values the variable takes on.<br><em>default</em>N&eq;1 is a constant, which can be included as
