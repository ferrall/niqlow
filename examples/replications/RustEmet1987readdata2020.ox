...
//        for(skip=FALSE;skip<=TRUE;++skip)
        ...
        savemat(outdir+"RustEmet1987_col"+sprint(col+1)+"_ALL.dta",glist[FALSE],SVnames);
...
*/
read(curf,SkipFirst) {
    decl i,f,b,xnew,width,indata,curh,k,bus,repm,prev,N,Ntot=0,smp,myhead,myid,dfx,rind,ib,stillsome;
