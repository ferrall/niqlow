	...
	static const  decl
        /** 2x3x2x4 array of reported parameter estimates. **/
	           parlist 	= {
                            ...
                            {   //Table X NX=175
                                {// Column 1.
                                    {  11.7257, 2.4569, < .0937,.4475 ,.4459,1-.0937-.4475-.4459>, -3993.991, <2.597;.9122;.0047;.008;.008;.0018>  },
                                    {  8.2969, 56.1657, < .0937,.4475 ,.4459,1-.0937-.4475-.4459>,  -3996.353,<1.0477;13.4205;.0047;.008;.008;.0018>  }
                                },
                                {// Column 2.
                                    { 10.896 , 1.1732, < .1191,.5762 ,.2868,1-.1191-.5762-.2868>, -4495.135,<1.581;.327;.005;.0075;.0069;.0019>  },
                                    {  7.6423 , 36.6692, <.1191,.5762 ,.2868,1-.1191-.5762-.2868>,-4496.997,<.7204;7.0675;.005;.0075;.0069;.0019> }
                                },
                                {// Column 3.
                                    { 9.7687, 1.3428, < .1071,.5152 ,.3621,1-.1071-.5152-.3621>, -8607.889,<1.226;.315;.0034;.0055;.0053;.0013>},
                                    { 7.3113, 36.0175, < .1071,.5152 ,.3621,1-.1071-.5152-.3621>, -8614.238,<.5073;5.5145;.0034;.0055;.0053;.0143>}
                                }
                            }
                            },
