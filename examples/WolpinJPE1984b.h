...
struct Fertility2 : OneDimensionalChoice	{
    /** State space dimensions. @names dimens **/ enum{T=20,tau=10,Mmax=5}
	...
	static const decl
						...
						Sbar = 2.0,
						va  = {<9.35,8.52,9.21,10.13,10.82,8.52>,
							   <0.00,0.00,0.00,00.00,00.00,0.088>},
						vb =  {<2.78,2.09,1.67,1.33,1.05,1.05>,
